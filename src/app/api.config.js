...
var ApiConfig = (function () {
    ...
    ApiConfig.getApiUrl = function () {
        return "http://cmsdev.helpfooter.com/alucard263096/drewface/api/";
    };
    ApiConfig.getUploadPath = function () {
        return "http://cmsdev.helpfooter.com/alucard263096/drewface/upload/";
    };
    ApiConfig.getFileUploadAPI = function () {
        return "http://cmsdev.helpfooter.com/alucard263096/drewface/fileupload";
    };
    ApiConfig.getDataBaseName = function () {
        return "alucard263096_drewface.db";
    };
    ...
    ApiConfig.ErrorHandle = function (url, post, error) {
        return Observable_1.Observable.throw(error.json().error || 'Server Error').toPromise();
    };
    return ApiConfig;
}());
