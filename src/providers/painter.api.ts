...
public list(search_condition_json, showLoadingModal:boolean=true) {
        var url = ApiConfig.getApiUrl()+"painter/list";
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if(ApiConfig.DataLoadedHandle("painter/list",search_condition_json,res)){
                  if(showLoadingModal){
            ...
            .catch(err => {
                ...
                return ApiConfig.ErrorHandle("painter/list",search_condition_json,err);
            });
...
public get(id, showLoadingModal:boolean=true) {
        var url = ApiConfig.getApiUrl()+'painter/get';
        let json={ 'id' : id };
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
              if(ApiConfig.DataLoadedHandle('painter/get',json,res)){
                  if(showLoadingModal){
                     ApiConfig.DimissLoadingModal();
                  }
            ...
            .catch(err => {
                ...
                return ApiConfig.ErrorHandle('painter/get',json,err);
            });
