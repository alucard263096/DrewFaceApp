...
public list(search_condition_json, showLoadingModal:boolean=true) {
        var url = ApiConfig.getApiUrl()+"paintertype/list";
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if(ApiConfig.DataLoadedHandle("paintertype/list",search_condition_json,res)){
                  if(showLoadingModal){
            ...
            .catch(err => {
                ...
                return ApiConfig.ErrorHandle("paintertype/list",search_condition_json,err);
            });
